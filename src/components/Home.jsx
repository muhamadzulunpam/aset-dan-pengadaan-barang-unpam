...
import carausel1 from "../assets/img/carousel-1.jpg";
import carausel2 from "../assets/img/carousel-2.jpg";
import carausel3 from "../assets/img/carousel-3.jpg";
import logoSpotify from "../assets/img/small-logos/logo-spotify.svg";
import flagsUS from "../assets/img/icons/flags/US.png";
import flagsDE from "../assets/img/icons/flags/DE.png";
import flagsGB from "../assets/img/icons/flags/GB.png";
import flagsBR from "../assets/img/icons/flags/BR.png";
...
export default function Home() {
  const handleLogout = async () => {
    ...
    try {
      // Initialize CSRF token terlebih dahulu
      ...
      if (response.status === 200 || response.status === 204) {
        // Clear local storage/token/session
      ...
      // Fallback: tetap clear storage dan redirect meski API error
      localStorage.removeItem("auth_token");
      localStorage.removeItem("user_data");
      navigate("/signin");
          ...
          <div className="flex flex-wrap mt-6 -mx-3">
            ...
            <div className="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
              ...
              >
                ...
                >
                  <img class={carausel1} alt="carousel image" />
                  ...
                  <table className="items-center w-full mb-4 align-top border-collapse border-gray-200 dark:border-white/40">
                    ...
                    <tbody>
                      <tr>
                        <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                          <div className="flex items-center px-2 py-1">
                            <div>
                              <img src={flagsUS} alt="Country flag" />
                            </div>
                            <div className="ml-6">
                      ...
                      <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                        <div className="flex items-center px-2 py-1">
                          <div>
                            <img src={flagsDE} alt="Country flag" />
                          </div>
                          <div className="ml-6">
                    ...
                    <tr>
                      <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                        <div className="flex items-center px-2 py-1">
                          <div>
                            <img src={flagsGB} alt="Country flag" />
                          </div>
                          <div className="ml-6">
                            <p className="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Country:</p>
                    ...
                    <tr>
                      <td className="p-2 align-middle bg-transparent border-0 w-3/10 whitespace-nowrap">
                        <div className="flex items-center px-2 py-1">
                          <div>
                            <img src={flagsBR} alt="Country flag" />
                          </div>
                          <div className="ml-6">
                            <p className="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Country:</p>
